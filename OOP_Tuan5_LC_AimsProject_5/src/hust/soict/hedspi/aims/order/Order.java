...
public class Order {
    ...
    public void addDigitalVideoDisc(DigitalVideoDisc disc) {
        if (qtyOrdered == MAX_NUMBERS_ORDERED) {
            ...
            if (checkDVDInOrderDVDList(disc, itemsOrdered))
    ...
    public DigitalVideoDisc getALuckyItem() {
        ...
        int luckyNumber = rn.nextInt(qtyOrdered) ;
        DigitalVideoDisc[] luckyDVD = {itemsOrdered[luckyNumber]};
        System.out.println("Thông tin DVD may mắn được free: ");
        printDigitalVideoDisc(luckyDVD);
